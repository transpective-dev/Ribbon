...
export const system_init: Record<string, CommandObject> = {
    ...
    pack: {
        ...
        abs: "search code ripgrep",
        desc: "Search for a given string in files, showing line numbers.",
        cmd: "bun build --minify --compile ./launcher.ts --bundle --target=bun --outfile=./.ribbon/launcher.exe && bun build--compile --bundle --target=bun ./src/logics/index.ts --outfile=./.ribbon/ribbon.exe --minify",
        tags: ["search", "rg", "code"]
    }
